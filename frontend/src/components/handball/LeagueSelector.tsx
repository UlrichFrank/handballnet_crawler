...
export function LeagueSelector({
  ...
  return (
    <select
      ...
      className="w-full px-3 md:px-4 py-2 text-sm md:text-base border border-gray-300 dark:border-slate-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 hover:border-gray-400 dark:hover:border-slate-500 transition-colors appearance-none"
      style={{
